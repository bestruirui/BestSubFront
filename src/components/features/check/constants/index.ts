...
export const UI_TEXT = {
    ...
    RUN_SUCCESS: '检测任务运行成功',
    RUN_FAILED: '检测任务运行失败',
    CREATE_SUCCESS: '检测任务创建成功',
    UPDATE_SUCCESS: '检测任务更新成功',
    DELETE_SUCCESS: '检测任务删除成功',
    CREATE_FAILED: '创建检测任务失败',
    UPDATE_FAILED: '更新检测任务失败',
    DELETE_FAILED: '删除检测任务失败',
    LOAD_TYPES_FAILED: '加载检测类型失败',
    LOAD_CONFIG_FAILED: '加载检测类型配置失败',
} as const
